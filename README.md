...
- Open `/tmp/workspace/embiimob/SupTikker/index.html` directly in a browser.
...
- Includes testnet3 WIF wallet unlock + auto posting loop with configurable interval (default 60 minutes, supports `0` for immediate loop when funded).
